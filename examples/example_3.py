...
from example_utilities import draw_point_clouds, get_point_clouds_real
...
def main():
    ...
    # Get source point cloud X and target point cloud Y.
    X, Y = get_point_clouds_real()
    ...
    Ds = [256, 256, 256, 256, 256]
    ls = [4.0, 2.0, 1.0, 0.5, 0.25]
    Ws = []
